...
userRouter.get("/user/request",userAuth,async(req,res)=>{
    ...
    const getallConnectionRequest= await connectionRequestModel.find({toUserid:userid, status:"interested",
    ...
    res.status(200).send({message:getallConnection});
...
userRouter.get("/user/feed", userAuth, async (req, res) => {
    try {
       ...
       const limit=parse(req.query.limit) || 10;
